...
\subsection{Apparition de la phase géométrique --- MEH}\label{subsub:intro_phaseg}
...
\begin{annexe}
	...
	\begin{demo}[de la \cref{prop:mom_freq}]
		...
		La seconde \cref{eq:var_freq} ce montre de la même façon.
	\end{demo}
	\skipl
	...
	\begin{align*}
		\Fou{\SA{x}\big.} = 2\one_{\R^+}\fou{x} \ \Llr\ \SA{x} &= \iFou{\one_{\R^+}\fou{x}} \\
