...
Ainsi, la phase géométrique de toute courbe cyclique $\gamma$ est donnée par l'aire\footnote{\itshape
	\thoughts{Oui c'est sensé être la demi-aire mais j'ai pas de facteur 1/2 qui apparaît dans les calculs... \cf~annexe \ref{ann:stokes}}}
...
\thoughts{D'abord il va falloir que j'explique que si on concatène deux chemins, les phases du nouveau chemin sont la somme des deux anciens.}
\\
...
\\
\thoughts{Et là je coince, j'arrive pas a comprendre comment se débarrasser du $\pi$...}
