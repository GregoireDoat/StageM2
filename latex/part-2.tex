...
\[{h_i}(x,e) = \sigma_i(x)\]
\\
\begin{definition}[Cartes locales de VFP]
...
Pour interpréter géométriquement les phases géométrique et dynamique, il nous faut munir $P(G,B)$ d'une connexion. Pour cela, commençons par noter que, $B$ étant une variété  \textbf{blbblblbbllbbll}


\subsubsection{Espace horizontaux et connexion}
