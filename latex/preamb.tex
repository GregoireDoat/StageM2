...
\newcommand{\asym}[1]{\mathcal{A}_{#1}(\R)}
...
\newcommand{\conti}[2]{\mathscr{C}\left(#1,#2\right)}
...
\newenvironment{annexe}{%
	...
	\titlecontents{section}[0.25em]{\addvspace{0.5em}\bfseries Annexe }{\quad ---\quad}{\hspace*{-1.5em}}{\titlerule*[0.75pc]{.}\contentspage}
