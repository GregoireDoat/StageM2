...
\titlecontents{part}[2em]{\bfseries\large\scshape 
	\hspace*{-1.5em}\rule{\textwidth}{0.5pt}\vspace{0.1cm}\\*
	 }{Partie\quad \contentslabel{-0.05em}\quad\ ---\quad}{\contentslabel{-1.5em} }{\hfill\contentspage}[\hspace*{-0.5em}
\rule{\textwidth}{0.5pt}]
...
\newenvironment{annexe}{%
	...
	% changement title part
	\titleformat{\part}[display]{\bfseries\scshape\Large}{\centering}{15pt}{\centering}
	...
	\titlecontents{part}[0.25em]{\addvspace{0.5em}\bfseries }{}{\hspace*{-1.5em}}{\titlerule*[0.75pc]{.}\contentspage}
	...
	\renewcommand{\thefigure}{\itshape\Alph{part}.\arabic{figure}}
}{
\titlecontents{section}[1.5em]{\addvspace{1em}\bfseries}{\contentslabel{1.25em} ---\quad}{\hspace*{-1.75em}}{\titlerule*[0.75pc]{.}\contentspage}[\addvspace{0.25em}]
