...
% les styles
\definecolor{colorbar}{RGB}{255,215,0}
\mdfdefinestyle{barred}{leftmargin=-0.5cm, 	% tailles des marges
	linewidth=0.1cm, linecolor=colorbar, 	% box' style
	topline=false, bottomline=false, rightline=false}	% coté de la box
	
\mdfdefinestyle{demo style}{leftmargin=0cm, 	% tailles des marges
	linewidth=0.4pt, linecolor=black, 	% box' style
	topline=false, bottomline=true, leftline=false, rightline=false,
	innerbottommargin=0.5cm}	% coté de la box

\mdfdefinestyle{doublebarr}{leftmargin=-0.5cm, 	% tailles des marges
	linewidth=0.1cm, linecolor=colorbar,
	doubleline=true, doublesep=0.1cm, 	% box' style
	topline=false, bottomline=false, rightline=false}	% coté de la box
...
\makeatother
\theoremstyle{empty}
\theoremprework{\qquad\qquad\qquad\rule{3.5cm}{0.4pt}\qquad\quad \textit{Démonstration}\qquad\quad \rule{3.5cm}{0.4pt}\newline}
\theoremheaderfont{\itshape}
\theoremseparator{\quad ---\quad}
\theoremnumbering{arabic}
\theorembodyfont{\itshape}
%\theoremsymbol{\rule{7cm}{0.4pt}}

\newmdtheoremenv[style=demo style]{demo}{Démonstration}
...
\renewcommand{\thefigure}{\itshape\arabic{section}.\arabic{figure}}
...
\usepackage{ntheorem}
% liste des sections
\titleclass{\part}[-2]{top} % 0 = niveau de section
