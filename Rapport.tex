...
On s'intéresse à des signaux multivarié, c'est-à-dire des applications à valeur de $\R$ (le temps typiquement) dans $\R^n$.  Dans le cas $n=1$ un signal $x\in L^2(\R)$ s'écrit sous la forme :
\begin{align*}
...
\begin{itemize}
	...
	\[M(t) = \Re e \big(iz\overline{z}'\big)\]
\end{itemize}
