...
\begin{table}[b]\centering
	\begin{tabular}{|| c | c ||} \hline
		...
		Matrice de rotation d'angle $\theta$  &  $R_\theta$  \\  \hline
	\end{tabular}
...
\end{proposition}
\begin{demo}%[\cref{prop:phased_2var}]
...
\begin{proposition}[phase de signal AM--FM--PM]\label{prop:phased_nvar}
	...
	\\
	la phase dynamique de $\bf{x}$ est donnée par :
	\begin{equation}\label{eq:phased_bivar}
		\begin{aligned}
			\phased(\bf{x}, t_0,t) &= \int_{t_0}^t \dot{\varphi}(s) + \dot{\Theta}(s) \frac{1}{2} \frac{d}{d\Theta}\big\|R_{\Theta(s)}\mathcal{V}(s)\big\|^2 ds \\
			&= \varphi(t) -\varphi(t_0) + \frac{1}{2}\int_{t_0}^t\dot{\Theta}(s) \frac{d}{d\Theta}\big\|R_{\Theta(s)}\mathcal{V}(s)\big\|^2 ds
		\end{aligned}
	\end{equation}
	En particulier, on remarque que pour $n=2$ :
	\[\frac{d}{d\Theta}\big\|R_{\Theta(s)}\mathcal{V}(s)\big\|^2 = \sin 2\chi \]
\end{proposition}
