...
\begin{itemize}
	...
	Suite à quoi elle sera explicitement calculée dans une cas particulier de signaux, déjà étudié par Le Bihan \etal~\cite{le_bihan_geometric_2024} : les signaux AM-FM-PM.
...
\begin{annexe}\input{latex/part-1_ann}\end{annexe}


\part{Aspects Géométriques d'une Phase Éponyme} \label{part:phase_geo} \input{latex/part-2}
\begin{annexe}\input{latex/part-2_ann}\end{annexe}
