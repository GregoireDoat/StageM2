...
Dans cette \cref{sec:lift_approch}, $\psi$ sera toujours supposée pseudo-cyclique :
\begin{definition}
...
\begin{align*}
	...
	\mathcal{C}_c &= \big\{ \phi(t)\in\C^n\ |\  t\in\R \big\}  &  \phi(t) = \phi(t_0)
\end{align*}
Quand on dit que $\Tilde{\psi}$ est l'hoizontal lift, on sous entend que :
