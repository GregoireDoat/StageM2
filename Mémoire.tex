...
\begin{enumerate}[label=\Roman* --- ]
	...
	\begin{enumerate}[label=\arabic* --- ]
		...
		\begin{itemize}
			...
			\item Explique le dessin de Bohm
			
			\item Ils ont un peu de géo diff \cite{mukunda_quantum_1993,bohm_geometric_2003} mais nous on veut écrire ca propre
		\end{itemize}
		
		\item On veut un description géo diff, on a besoin de quoi ?
		\begin{itemize}
	...
	\begin{enumerate}[label=\arabic* --- ]
		...
		\begin{enumerate}[label=\arabic{enumi}.\arabic* --- ]
			...
			\begin{itemize}
				\item C'est super rélou les transports de structure mais nous on évite le problème parce que c'est un produit et la fibre EST le groupe de Lie.
			\end{itemize}
...
Aussi, chose remarquable, le fait que la phase géométrique soit invariante par jauge transfo réapprait dans le fait que $\phi$ ne soit pas définie à jauge tranfo près (sauf au bord). Par contre c'est étrange que 
