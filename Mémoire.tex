...
La phase géométrique fait partie de ces concepts qui apparaissent régulièrement en physique, mais qui demande énormément de prérequis pour être expliqué.
...
Ce n'est que récemment que Le Bihan, Flamant et Amblard se sont intéresser à son application en traitement du signal dans le cas de signaux bivariés à bande fine \cite{le_bihan_modephysiques_2023, le_bihan_geometric_2024}.
\\
...
\\
Dans une première partie, les résultats de Le Bihan \etal~seront (rapidement) présentés, ce qui fera office d'exemple pour mieux introduire la phase géométrique. 
\\
Suite à quoi, dans une seconde partie, le phénomène sera décrit d'un point de vue géométrique, ce qui demandera de rappelé, entre autre, des résultats sur les variétés complexes et fibrées principales.
\\
...
- code notebook
- qui est quelle phase
- mail à berthier pour les contraintes rapport
